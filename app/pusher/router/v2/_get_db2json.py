...
from database.connector import (
    get_db_config_session, 
    get_db_worker_session
)
...
async def get_live_config(
    ...
    with get_db_config_session() as config_db_session:
        ...
        if live_config_data:
            live_config_data_json = [x.live_data_dict() for x in live_config_data]
...
async def get_live_logs(
    ...
    with get_db_worker_session(json_uid, live_uuid) as worker_db_session:
        page = int(page)
        page_size = 1000
        ...
        data = {
            "live_config": {
                ...
                "base": live_config_data.live_data_dict(),
            },
